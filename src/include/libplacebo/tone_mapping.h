...
enum pl_hdr_scaling {
    PL_HDR_RELATIVE = 0,    // 0.0 is absolute black, 1.0 is PL_COLOR_SDR_WHITE
    PL_HDR_SQRT,            // sqrt() of PL_HDR_RELATIVE values
...
// The parameter gives the pivot point (in PQ space), defaulting to 0.36.
